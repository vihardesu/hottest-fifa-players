...
export function LegalPage({ title, lastUpdated, children }: LegalPageProps) {
  return (
    <article className="flex flex-1 flex-col gap-6 pb-4">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-[#4F4D46]/85 md:text-base [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-[#4F4D46] md:[&_h2]:text-lg [&_p]:mt-2 [&_ul]:mt-2 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5">
        {children}
      </div>
    </article>
  );
